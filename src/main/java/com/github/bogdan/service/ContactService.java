        ...
        for(User user: userDao.queryForAll()){
            if(user.getPhone()!= null) {
                if (user.getPhone().equals(phone)) {
                    throw new WebException("This number is already in use", 400);
                }
            }
        }
    }
